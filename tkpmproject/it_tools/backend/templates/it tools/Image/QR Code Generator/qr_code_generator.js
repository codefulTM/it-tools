...
generateButton.addEventListener('click', () => {
    const text = document.getElementById('text').value.trim().toUpperCase();
    const fg = document.getElementById('input-foreground').value;
    const bg = document.getElementById('input-background').value;
    const level = document.getElementById('error-resistance').value;
    try {
        const dataUrl = generateQRCode(text, level, fg, bg);
