...
class Tool8(ToolComponent):
    ...
    def get_html(self):
        return """<h2 style="margin-bottom:5px;">Bcrypt</h2>
...
<div style="padding:15px; border-radius:5px; margin-bottom:30px;">
    ...
    <label style="display:block; margin-bottom:8px;">
        ...
        <input id="hashString" type="text" placeholder="Enter text…"
    ...
    <label style="display:flex; align-items:center; margin-bottom:15px; gap:10px;">
        ...
        <button onclick="decSalt()"

            style="width:24px; height:24px; background:#444; color:white; border:none; border-radius:4px; cursor:pointer;">–</button>
...
<script src="https://cdn.jsdelivr.net/npm/bcryptjs@2.4.3/dist/bcrypt.min.js"></script>"""
    ...
    def get_js(self):
        return """const hashString = document.getElementById('hashString');
